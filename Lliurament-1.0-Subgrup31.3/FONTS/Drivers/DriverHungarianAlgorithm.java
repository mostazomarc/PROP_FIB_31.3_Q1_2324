...
public class DriverHungarianAlgorithm {
    public static void main(String[] args) {
        ...
        double[][] test = {
                //col0  col1  col2  col3
                {70.5, 40.5, 20.5, 55.5},  //row0
                {65.5, 60.5, 45.5, 90.5},  //row1
                {30.5, 45.5, 50.5, 75.5},  //row2
                {25.5, 30.5, 55.5, 40.5}   //row3
        };
...
//                ));
        ...
        System.out.println("----------------- \n");
        HungarianAlgorithm ha = new HungarianAlgorithm(test);
        double valoroptim = ha.trobarAssignacioOptima();
        System.out.println(" Valor optim = " + valoroptim + "\n");


//        for (int i = 0; i < aux.length; ++i) {
//            for (int j = 0; j < aux.length; ++j) {
//                System.out.println(" valor[" + i + "][" + j + "] = " + aux[i][j] + "\n");
//            }
//        }
        // ++testNumber;
