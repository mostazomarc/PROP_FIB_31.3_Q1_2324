...
@SuiteClasses(value = {
        ...
        CtrlPersTeclatsTest.class, GreedyTest.class, HungarianAlgorithmTest.class, IdiomaTest.class, LlistaFrequenciesTest.class, NodoTest.class, PerfilTest.class, posTest.class, TeclatTest.class, InputFrequenciesTest.class
})
/**
